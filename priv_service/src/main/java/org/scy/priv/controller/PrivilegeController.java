...
public class PrivilegeController extends BaseController {
    ...
    public Object getGroupPrivs(int groupId) {
    ...
    public Object getRolePrivs(int roleId) {
    ...
    public Object getUserAllPrivs(int userId) {
    ...
    public Object checkPrivileges(HttpServletRequest request, int userId) {
        if (userId <= 0)
    ...
    public Object checkPrivilege(HttpServletRequest request, int userId, String module) {
        if (userId <= 0)
            return HttpResult.error(Const.MSG_CODE_PARAMINVALID, "用户编号无效");
